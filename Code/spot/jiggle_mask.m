...
%[p,mask1luc,~]=LucasKanadeAffine(double(mask1),[0 0 0 0 128 64],double(mask2), options);
[p,mask1luc,~]=lucas_mex(double(mask1),[0 0 0 0 128 64],double(mask2), ones(size(mask2)),options);
